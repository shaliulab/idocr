...
class TestSrc(test_generic.TestGeneric, Interface):

    def __init__(self, *args, **kwargs):

        super(TestSrc, self).__init__(*args, **kwargs)
        ...
        camera='opencv', gui="tkinter", video = Path(ROOT_DIR, "videos/ouptut.avi").__str__(),
