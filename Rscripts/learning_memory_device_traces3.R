...
setwd(base_dir)
filename <- '2019-08-23_18-39-57/2019-08-23_18-39-57_LeMDTe27SL5a9e19f94de287e28f789825.csv'
...
first_odour_choice_start <- 0.1 # minutes
first_odour_choice_end <- 0.1 # minutes
second_odour_choice_start <- 2 # minutes
second_odour_choice_end <- 4 # minutes




#DOUR_B_MCH_RIGHT,5,10,NaN,NaN,
#ODOUR_B_MCH_LEFT,15,20,NaN,NaN,



rect_data <- data.frame(xmin = c(first_odour_choice_start, first_odour_choice_start, second_odour_choice_start, second_odour_choice_start),
                        xmax = c(first_odour_choice_end, first_odour_choice_end, second_odour_choice_end, second_odour_choice_end),
